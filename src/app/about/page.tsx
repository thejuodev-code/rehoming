                    ...
                    <div className="max-w-[90rem] mx-auto px-6 sm:px-8 lg:px-12">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.6fr] gap-10 items-start">
                            ...
                            <motion.div
                                ...
                                className="space-y-5"
                            >
                                <div className="bg-white border border-gray-100 rounded-3xl p-8 shadow-[0_2px_20px_rgb(0,0,0,0.02)] space-y-7">
                                    <div className="flex items-start gap-4">
                                        <div className="w-12 h-12 bg-blue-50/80 text-blue-600 rounded-2xl flex items-center justify-center flex-shrink-0">
                                        ...
                                        <div className="w-full">
                                            <p className="text-[13px] font-bold text-gray-400 mb-2">주소</p>
